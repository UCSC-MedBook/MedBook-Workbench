CohortController = RouteController.extend({
    ...
    waitOn : function() {
        ...
        var pivotEvent = sigNames ? sigNames[0] : null;
        Meteor.subscribe('correlator', pivotEvent, correlatorLimit);
        console.log('correlator subscription', 'pivotEvent:', pivotEvent, 'correlatorLimit:', correlatorLimit, s);
